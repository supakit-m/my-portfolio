  ...
  <section class="lg:col-span-1 space-y-16">
    ...
    <div>
      ...
      >
        ...
        <div class="relative group">
          <div
            class="absolute -left-12.75 top-1 w-5 h-5 bg-primary rounded-full shadow-[0_0_15px_#81ecff]"
          ></div>
          <div
    ...
    <div>
      ...
      <div class="relative border-l-2 border-surface-container-high ml-4 pl-10">
        <div class="relative">
          <div
            class="absolute -left-12.75 top-1 w-5 h-5 bg-surface-container-high rounded-full border-2 border-primary"
          ></div>
          <div
            class="flex flex-col md:flex-row md:items-baseline justify-between mb-2"
          >
